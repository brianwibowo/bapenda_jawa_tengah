...
class PengajuanController extends Controller
{
    ...
    public function generateSkRegident(Request $request, Pengajuan $pengajuan)
    {
        ...
        $dataPdf = [
            ...
            'data' => (object)[
                'nama' => optional($kendaraan->pemilik)->nama_pemilik ?? '-',
                'alamat' => optional($kendaraan->pemilik)->alamat_pemilik ?? '-',
                'nik' => optional($kendaraan->pemilik)->nik_pemilik ?? '-',
                'no_tlp' => optional($kendaraan->pemilik)->telp_pemilik ?? '-',
                'email' => optional($kendaraan->pemilik)->email_pemilik ?? '-',
                'nrkb' => $kendaraan->nrkb ?? '-',
                'merek' => $kendaraan->merk_kendaraan ?? '-',
                'tipe' => $kendaraan->tipe_kendaraan ?? '-',
                'jenis' => $kendaraan->jenis_kendaraan ?? '-',
                'model' => $kendaraan->model_kendaraan ?? '-',
                'tahun' => $kendaraan->tahun_pembuatan ?? '-',
                'isi_silinder' => $kendaraan->isi_silinder ?? '-',
                'no_rangka' => $kendaraan->nomor_rangka ?? '-',
                'no_mesin' => $kendaraan->nomor_mesin ?? '-',
                'warna_kendaraan' => $kendaraan->warna_kendaraan ?? '-',
                'bahan_bakar' => $kendaraan->jenis_bahan_bakar ?? '-',
                'warna_tnkb' => $kendaraan->warna_tnkb ?? '-',
                'no_bpkb' => $kendaraan->nomor_bpkb ?? '-',
            ]
        ];
    ...
    public function generateSkPolda(Request $request)
    {
        ...
        $dataPdf = [
            ...
            'data' => (object)[
                ...
                'nama' => optional($kendaraan->pemilik)->nama_pemilik ?? '-',
                'alamat' => optional($kendaraan->pemilik)->alamat_pemilik ?? '-',
                'jenis_model' => ($kendaraan->jenis_kendaraan ?? '-') . '/' . ($kendaraan->model_kendaraan ?? '-'),
                'merek_tipe' => ($kendaraan->merk_kendaraan ?? '-') . '/' . ($kendaraan->tipe_kendaraan ?? '-'),
                'tahun' => $kendaraan->tahun_pembuatan ?? '-',
                'isi_silinder' => $kendaraan->isi_silinder ?? '-',
                'bahan_bakar' => $kendaraan->jenis_bahan_bakar ?? '-',
                'no_rangka' => $kendaraan->nomor_rangka ?? '-',
    ...
    public function generateSkPenghapusanRegident(Request $request, Pengajuan $pengajuan)
    {
        ...
        $dataPdf = [
            ...
            // Dari Database Kendaraan/Pemilik
            'nama_pemohon' => optional($kendaraan->pemilik)->nama_pemilik ?? '-',
            'alamat' => optional($kendaraan->pemilik)->alamat_pemilik ?? '-',
            'nomor_identitas' => optional($kendaraan->pemilik)->nik_pemilik ?? '-',
            'nama_resident' => $kendaraan->nrkb ?? '-',
            'id_resident' => $kendaraan->nrkb ?? '-',
    ...
    public function generateSkJasaRaharja(Request $request, Pengajuan $pengajuan)
    {
        ...
        $dataPdf = [
            ...
            'data' => (object)[
                ...
                'alamat' => $pemilik->alamat_pemilik ?? '-',
                'nik' => $pemilik->nik_pemilik ?? '-',
                'no_tlp' => $pemilik->telp_pemilik ?? '-',
                ...
                'warna_tnkb' => $kendaraan->warna_tnkb ?? '-',
                'no_bpkb' => $kendaraan->nomor_bpkb ?? '-',
                'merk_type' => trim(($kendaraan->merk_kendaraan ?? '') . ' / ' . ($kendaraan->tipe_kendaraan ?? '-')),
                'no_rangka_mesin' => trim(($kendaraan->nomor_rangka ?? '') . ' / ' . ($kendaraan->nomor_mesin ?? '-')),
                'jenis_model' => trim(($kendaraan->jenis_kendaraan ?? '') . ' / ' . ($kendaraan->model_kendaraan ?? '-')),
            ],
        ];
