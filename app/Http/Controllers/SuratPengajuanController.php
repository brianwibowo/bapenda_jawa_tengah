    ...
    public function generateSPBalasanJR(Request $request, Pengajuan $pengajuan)
    {
        ...
        $dataPdf = [
            ...
            'data' => (object)[
                ...
                'no_rangka_mesin' => ($firstKendaraan->nomor_rangka ?? '-') . '/' . ($firstKendaraan->nomor_mesin ?? '-'),
                'jenis_model' => ($firstKendaraan->jenis_kendaraan ?? '-') . '/' . ($firstKendaraan->model_kendaraan ?? '-'),
        ...
        if ($unitKerja == 'Polda') {
            ...
            foreach ($kendaraans as $k) {
                $log = $this->logSuratActionByKendaraanId(
                    $pengajuan,
                    $k->id,
                    'Surat Pengajuan dari Polda berhasil diterbitkan',
