...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/mymac/Documents/Codes/bapenda_jateng/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/mymac/Documents/Codes/bapenda_jateng/public/storage','logging.default','logging.deprecations.channel',
...
'session.secure','session.http_only','session.same_site','session.partitioned','media-library.disk_name',
...
'pengajuan.index','pengajuan.store','pengajuan.show','pengajuan.destroy','pengajuan.kendaraan.create',
'pengajuan.kendaraan.store','kendaraan.edit','kendaraan.update','kendaraan.destroy','kendaraan.show',
'admin.users.index','admin.users.create','admin.users.store','admin.users.show','admin.users.edit',
'admin.users.update','admin.users.destroy','admin.pengajuan.index','admin.pengajuan.show','admin.pengajuan.destroy',
'admin.pengajuan.storeLog','storage.local',);
        registerArgumentsSet('views', 
'admin.pengajuan.create','admin.pengajuan.index','admin.pengajuan.show','admin.users.create','admin.users.edit',
...
'dashboard','kendaraan.create','kendaraan.edit','kendaraan.show','layouts.app',
'layouts.guest','layouts.partials.footer','layouts.partials.header','layouts.partials.sidebar','pengajuan.create',
'pengajuan.index','pengajuan.show','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form',
'profile.partials.update-profile-information-form','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.copy-button',
