...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./workspaces/bapendajawatengah-gcloud-south-bapenda/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./workspaces/bapendajawatengah-gcloud-south-bapenda/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'dompdf.options.font_height_ratio','dompdf.options.enable_html5_parser','media-library.disk_name','media-library.max_file_size','media-library.queue_connection_name',
...
'dashboard','profile.edit','profile.update','profile.destroy','redirect.after.login',
'pengajuan.index','pengajuan.create','pengajuan.store','pengajuan.show','pengajuan.destroy',
'pengajuan.log.show','pengajuan.log.store','pengajuan.pilih_sk','kendaraan.store','kendaraan.create',
'kendaraan.store.old','admin.users.index','admin.users.create','admin.users.store','admin.users.show',
'admin.users.edit','admin.users.update','admin.users.destroy','admin.permissions.index','admin.permissions.create',
'admin.permissions.store','admin.permissions.destroy','admin.roles.index','admin.roles.create','admin.roles.store',
'admin.roles.show','admin.roles.edit','admin.roles.update','admin.roles.destroy','admin.cabangs.index',
'admin.cabangs.create','admin.cabangs.store','admin.cabangs.show','admin.cabangs.edit','admin.cabangs.update',
'admin.cabangs.destroy','admin.pengajuan.index','admin.pengajuan.show','admin.pengajuan.log.show','admin.pengajuan.destroy',
'admin.pengajuan.batchUpdate','admin.pengajuan.log.store','admin.pengajuan.pilih_sk','admin.pengajuan.generate_sk_regident','admin.pengajuan.generate_sk_pembebasan',
'admin.pengajuan.ajukan','admin.pengajuan.sp.terima','admin.pengajuan.sp.tolak','admin.pengajuan.buat_sk','kendaraan.show',
'kendaraan.edit','kendaraan.update','kendaraan.destroy','frame.access.request','frame.secure.render',
'preview.sk.regident','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'admin.cabangs.create','admin.cabangs.edit','admin.cabangs.index','admin.pengajuan.index','admin.pengajuan.show',
'admin.permissions.index','admin.roles.create','admin.roles.edit','admin.roles.index','admin.roles.show',
'admin.surat.view_keputusan','admin.surat.view_pengajuan','admin.users.create','admin.users.edit','admin.users.index',
...
'form.create_sk','form.create_sp','form.view_sk','form.view_sp','kendaraan.show',
'layouts.app','layouts.guest','layouts.partials.footer','layouts.partials.frame','layouts.partials.header',
'layouts.partials.sidebar','pdf.sk_bapenda_pembebasan','pdf.sk_penghapusan_regident','pdf.view_pengajuan','pdf.view_sk',
'pdf.view_sp','pengajuan.create','pengajuan.index','pengajuan.log_show','pengajuan.modals.sk_bapenda_pembebasan',
'pengajuan.modals.sk_regident','pengajuan.partials.form-template','pengajuan.partials.logs','pengajuan.pilih_sk','pengajuan.show',
